...
try {
  ...
  if (fs.existsSync(taktakSrc)) {
    ...
    <div id="taktak-leaderboard-panel" style="position:fixed;bottom:0;right:10px;background:rgba(10,10,30,0.97);padding:8px 14px 10px;border-radius:10px 10px 0 0;border:2px solid #00ff88;border-bottom:none;text-align:center;width:260px;font-family:Arial,sans-serif;z-index:10000;display:none;max-height:28vh;overflow-y:auto;font-size:11px;">
