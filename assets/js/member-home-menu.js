(function(){
  ...
  function styles(){
    ...
    style.textContent='.member-nav-shell{position:relative;display:inline-flex;min-width:0}.member-login-btn.is-member{display:inline-flex;align-items:center;gap:6px;max-width:172px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.member-account-menu{position:absolute;top:calc(100% + 9px);right:0;z-index:400;min-width:218px;padding:8px;background:#fff;border:1px solid #e1e5ea;border-radius:12px;box-shadow:0 16px 34px rgba(15,23,42,.16);display:none}.member-account-menu.is-open{display:grid;gap:3px}.member-account-menu a,.member-account-menu button{appearance:none;display:block;width:100%;border:0;background:transparent;padding:11px;border-radius:8px;text-align:left;text-decoration:none;color:#24292f;font:inherit;font-size:.88rem;font-weight:800;cursor:pointer}.member-account-menu a:hover,.member-account-menu button:hover{background:#f4f6f8;color:#e10600}.member-account-menu .member-logout{margin-top:5px;padding-top:11px;border-top:1px solid #e1e5ea;color:#b42318}@media(max-width:640px){.member-nav-shell{max-width:132px}.member-login-btn.is-member{max-width:132px;padding-left:10px!important;padding-right:10px!important}.member-account-menu{right:0;min-width:min(245px,86vw)}}';
  ...
  async function init(){
    ...
    try{
      ...
      link.textContent=memberName(active.user)+' ▾';
