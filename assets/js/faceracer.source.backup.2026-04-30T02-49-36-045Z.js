...
let WALL_LEFT = window.innerHeight > window.innerWidth ? -6.5 : -11;
let WALL_RIGHT = window.innerHeight > window.innerWidth ? 6.5 : 11;

window.addEventListener('resize', () => {
    WALL_LEFT = window.innerHeight > window.innerWidth ? -6.5 : -11;
    WALL_RIGHT = window.innerHeight > window.innerWidth ? 6.5 : 11;
});
...
function createRoad() {
    ...
    const roadWidth = isPortrait ? 12 : 20;
    ...
    const barrierOffset = isPortrait ? 6.5 : 11;
    
    const leftBarrier = new THREE.Mesh(barrierGeometry, barrierMaterial);
    leftBarrier.position.set(-barrierOffset, 1, -200);
    scene.add(leftBarrier);

    const rightBarrier = new THREE.Mesh(barrierGeometry, barrierMaterial);
    rightBarrier.position.set(barrierOffset, 1, -200);
...
function updateGame() {
    ...
    const WALL_LEFT = window.innerHeight > window.innerWidth ? -6.5 : -11;
    const WALL_RIGHT = window.innerHeight > window.innerWidth ? 6.5 : 11;
    const now = Date.now();
